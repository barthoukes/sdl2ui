...
CaudioDlg::CaudioDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "AUDIO", KEY_NONE)
...
void CaudioDlg::onExit()
{
}

void CaudioDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CaudioDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
