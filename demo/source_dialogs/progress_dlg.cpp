/*============================================================================*/
/**  @file    	progress_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for progress bar
 **
 **  Do waiter functions.
 **
 **  @author    mensfort
...
CprogressDlg::CprogressDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "PROGRESS", KEY_NONE)
...
///
/*============================================================================*/
Estatus CprogressDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
