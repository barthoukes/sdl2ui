...
CbuttonDlg::CbuttonDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "BUTTON", KEY_NONE)
...
void CbuttonDlg::onExit()
{
}

void CbuttonDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CbuttonDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
