...
CdragDlg::CdragDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "DRAG", KEY_NONE)
...
void CdragDlg::onExit()
{
}

void CdragDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CdragDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
