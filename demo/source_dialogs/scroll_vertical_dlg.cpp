/*============================================================================*/
/**  @file    	scroll_vertical_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for vertical scroll demo
 **
 **  @author    mensfort
 **
 **  @par Classes:
...
CscrollVerticalDlg::CscrollVerticalDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "SCROLL VERTICAL", KEY_NONE)
...
CscrollVerticalDlg::~CscrollVerticalDlg()
{
}

bool CscrollVerticalDlg::onInit()
{
	return true;
}
...
///
/*============================================================================*/
void CscrollVerticalDlg::onUpdate()
{
	assert(NULL);
}
...
///
/*============================================================================*/
void CscrollVerticalDlg::onPaint()
{
}

bool CscrollVerticalDlg::onLoop()
{
//	Ctimestamp c;
...
void CscrollVerticalDlg::onExit()
{
}

void CscrollVerticalDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CscrollVerticalDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
