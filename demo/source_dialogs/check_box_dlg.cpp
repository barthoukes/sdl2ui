/*============================================================================*/
/**  @file    	check_box_dlg.cpp
 **  @ingroup   group
 **  @brief		Dialog for check box demo
 **
 **  @author    mensfort
 **
 **  @par Classes:
...
CcheckBoxDlg::CcheckBoxDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "CHECK BOX", KEY_NONE)
...
void CcheckBoxDlg::onExit()
{
}

void CcheckBoxDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CcheckBoxDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
