...
CfontDlg::CfontDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "FONT", KEY_NONE)
...
void CfontDlg::onExit()
{
}

void CfontDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CfontDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
