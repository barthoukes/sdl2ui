/*============================================================================*/
/**  @file    	hand_writer_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for font demo
 **
 **  @author    mensfort
 **
 **  @par Classes:
...
ChandWriterDlg::ChandWriterDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "HAND WRITER", KEY_NONE)
...
ChandWriterDlg::~ChandWriterDlg()
{
}

bool ChandWriterDlg::onInit()
{
	return true;
}
...
///
/*============================================================================*/
void ChandWriterDlg::onPaint()
{
}

bool ChandWriterDlg::onLoop()
{
//	Ctimestamp c;
...
void ChandWriterDlg::onExit()
{
}

void ChandWriterDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus ChandWriterDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
