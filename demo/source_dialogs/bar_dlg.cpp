...
, m_header( Crect(0,0,m_squares_width,6), "BAR", KEY_NONE)
...
///
/*============================================================================*/
Estatus CbarDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
