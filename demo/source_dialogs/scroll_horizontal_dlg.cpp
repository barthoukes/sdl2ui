/*============================================================================*/
/**  @file    	scroll_horizontal_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for horizontal scroll demo
 **
 **  Do waiter functions.
 **
 **  @author    mensfort
...
CscrollHorizontalDlg::CscrollHorizontalDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "SCROLL HORIZONTAL", KEY_NONE)
...
CscrollHorizontalDlg::~CscrollHorizontalDlg()
{
}

bool CscrollHorizontalDlg::onInit()
{
	return true;
}
...
///
/*============================================================================*/
void CscrollHorizontalDlg::onUpdate()
{
	assert(NULL);
}
...
///
/*============================================================================*/
void CscrollHorizontalDlg::onPaint()
{
}

bool CscrollHorizontalDlg::onLoop()
{
//	Ctimestamp c;
...
void CscrollHorizontalDlg::onExit()
{
}

void CscrollHorizontalDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CscrollHorizontalDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
