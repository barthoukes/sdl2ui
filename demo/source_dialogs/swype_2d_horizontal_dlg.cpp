/*============================================================================*/
/**  @file    	swype_2d_horizontal_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for swype 2D
 **
 **  @author    mensfort
 **
 **  @par Classes:
 **             Cswype2DhorizontalDlg
 */
/*------------------------------------------------------------------------------
...
Cswype2DhorizontalDlg::Cswype2DhorizontalDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "SWYPE 2D HORIZONTAL", KEY_NONE)
...
Cswype2DhorizontalDlg::~Cswype2DhorizontalDlg()
{
}

bool Cswype2DhorizontalDlg::onInit()
{
	return true;
}
...
///
/*============================================================================*/
void Cswype2DhorizontalDlg::onUpdate()
{
	assert(NULL);
}
...
///
/*============================================================================*/
void Cswype2DhorizontalDlg::onPaint()
{
}

bool Cswype2DhorizontalDlg::onLoop()
{
//	Ctimestamp c;
...
void Cswype2DhorizontalDlg::onExit()
{
}

void Cswype2DhorizontalDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus Cswype2DhorizontalDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
