...
CimageDlg::CimageDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "IMAGE", KEY_NONE)
...
void CimageDlg::onExit()
{
}

void CimageDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CimageDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
