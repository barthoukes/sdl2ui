/*============================================================================*/
/**  @file    	swype_2d_vertical_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for swype 2D vertical
 **
 **  @author    mensfort
 **
 **  @par Classes:
...
Cswype2DverticalDlg::Cswype2DverticalDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "SWYPE 2D VERTICAL", KEY_NONE)
...
Cswype2DverticalDlg::~Cswype2DverticalDlg()
{
}

bool Cswype2DverticalDlg::onInit()
{
	return true;
}
...
///
/*============================================================================*/
void Cswype2DverticalDlg::onUpdate()
{
	assert(NULL);
}
...
///
/*============================================================================*/
void Cswype2DverticalDlg::onPaint()
{
}

bool Cswype2DverticalDlg::onLoop()
{
//	Ctimestamp c;
...
void Cswype2DverticalDlg::onExit()
{
}

void Cswype2DverticalDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus Cswype2DverticalDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
