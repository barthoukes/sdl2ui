...
/**  @file    	number_dlg.cpp
 **  @ingroup   demo
 **  @brief		Dialog for number editor
 **
 **  Do waiter functions.
 **
 **  @author    mensfort
...
CnumberDlg::CnumberDlg(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), "NUMBER", KEY_NONE)
...
void CnumberDlg::onExit()
{
}

void CnumberDlg::onCleanup()
{
}
...
///
/*============================================================================*/
Estatus CnumberDlg::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
