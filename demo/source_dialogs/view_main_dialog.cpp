/*============================================================================*/
/**  @file    	view_main_dialog.cpp
 **  @ingroup   demo
 **  @brief		Main dialog for demo
 **
 **  @author    mensfort
 **
 **  @par Classes:
...
CmainDialog::CmainDialog(Iworld *world)
: Cdialog( NULL,"CmainDialog", Crect(0,0,0,0), world)
, m_header( Crect(0,0,m_squares_width,6), _HEADER_TITLE, KEY_NONE)
...
bool CmainDialog::onInit()
{
	return true;
}

void CloseProgram( const std::string &s)
{
}
...
{
	// nothing to paint, because header is already registered
}

bool CmainDialog::onLoop()
{
//	Ctimestamp c;
...
///
/*============================================================================*/
Estatus CmainDialog::onButton(keymode mode, keybutton sym)
{
	if ( sym == KEY_CR )
	{
		stop(0);
